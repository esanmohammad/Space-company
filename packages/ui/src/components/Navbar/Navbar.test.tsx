...
describe('Navbar', () => {
  describe('Desktop rendering (TC-028)', () => {
    it('renders the brand name', () => {
      render(<Navbar brandName="Stark Space" links={TEST_LINKS} currentPath="/" />);
    ...
    it('sets aria-current="page" on the active link', () => {
      render(<Navbar brandName="Stark Space" links={TEST_LINKS} currentPath="/destinations" />);
  ...
  describe('Mobile rendering — hamburger & drawer (TC-030, TC-031, TC-032)', () => {
    ...
    it('TC-031: drawer contains nav links after hamburger click', async () => {
      ...
      const allDestLinks = screen.getAllByRole('link', { name: 'Destinations' });
