...
export { FeaturesGrid, default as FeaturesGridDefault } from './components/FeaturesGrid';
export type { FeaturesGridProps } from './components/FeaturesGrid';

export { MissionStrip, default as MissionStripDefault } from './components/MissionStrip';
...
export { ContactForm, default as ContactFormDefault } from './components/ContactForm';
export type { ContactFormProps } from './components/ContactForm';

export { CompanyInfoBlock, default as CompanyInfoBlockDefault } from './components/CompanyInfoBlock';
