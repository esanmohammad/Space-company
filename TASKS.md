...
- [x] T001 [P] [US1] Replace "Stellar" references in company info constants — `packages/ui/src/constants/companyInfo.ts`
...
- [x] T002 [P] [US1] Replace "Stellar Horizons" in feature card descriptions — `packages/ui/src/constants/featureCards.ts`
...
- [x] T003 [P] [US1] Update HTML title tag to "Moonshot" — `apps/web/index.html`
...
- [x] T004 [P] [US1] Replace brand name and social links in App container — `apps/web/src/App.tsx`
...
- [x] T006 [P] [US1] Update Navbar test assertions from "Stellar Horizons" to "Moonshot" — `packages/ui/src/components/Navbar/Navbar.test.tsx`
...
- [x] T007 [P] [US1] Update Footer test assertions for brand name and social URLs — `packages/ui/src/components/Footer/Footer.test.tsx`
...
- [x] T008 [P] [US1] Update CompanyInfoBlock test fixtures for address and email — `packages/ui/src/components/CompanyInfoBlock/CompanyInfoBlock.test.tsx`
...
- [x] T009 [P] [US1] Update navigation test brandName prop — `apps/web/src/__tests__/navigation.test.tsx`
...
- [x] T010 [P] [E2E] [US1] Verify landing page brand display end-to-end — `e2e/landing.spec.ts`
...
- [x] T011 [P] [E2E] [US1] Verify navigation brand and social links end-to-end — `e2e/navigation.spec.ts`
  - AC: If any assertions reference "Stellar Horizons", update them to "Moonshot"
...
- [x] T012 [P] [E2E] [US1] Verify contact page brand info end-to-end — `e2e/contact-form.spec.ts`
...
- [x] T013 [US1] Verify zero remaining "Stellar Horizons" references — `apps/web/index.html`
...
- [x] T014 [US1] Visual verification of all pages — `e2e/mobile-navbar.spec.ts`
  - AC: If any assertions reference "Stellar Horizons", update them to "Moonshot"
