...
- [x] T001 [P] [US1] Create root package.json with pnpm workspaces and turbo dev dependency — `package.json`
...
- [x] T002 [P] [US1] Create pnpm workspace manifest — `pnpm-workspace.yaml`
  - AC: Lists `apps/*` and `packages/*` globs; pnpm recognises all workspace packages on `pnpm install`
- [x] T003 [P] [US1] Create Turborepo pipeline config — `turbo.json`
...
- [x] T004 [P] [US1] Create root .gitignore — `.gitignore`
  - AC: Ignores `node_modules`, `dist`, `.turbo`, `.env*`, coverage directories, and Playwright report folders
- [x] T005 [P] [US1] Create shared TypeScript config package manifest — `packages/tsconfig/package.json`
  - AC: `name` is `@space-tourism/tsconfig`; no runtime dependencies; exports `base.json`
- [x] T006 [P] [US1] Create shared TypeScript base config — `packages/tsconfig/base.json`
...
- [x] T007 [P] [US1] Create shared ESLint config package manifest — `packages/eslint-config/package.json`
  - AC: `name` is `@space-tourism/eslint-config`; peerDepends on `eslint`; exports `index.js`
- [x] T008 [P] [US1] Create shared ESLint config rules — `packages/eslint-config/index.js`
...
- [x] T009 [P] [US1] Create `packages/ui` package manifest — `packages/ui/package.json`
...
- [x] T010 [P] [US1] Create `packages/ui` TypeScript config — `packages/ui/tsconfig.json`
  - AC: Extends `@space-tourism/tsconfig/base.json`; `include: ["src"]`; resolves correctly under pnpm workspace
- [x] T011 [P] [US1] Create `apps/web` package manifest — `apps/web/package.json`
...
- [x] T012 [P] [US1] Create `apps/web` TypeScript config — `apps/web/tsconfig.json`
  - AC: Extends `@space-tourism/tsconfig/base.json`; `include: ["src"]`; `types` array includes `vite/client`
- [x] T013 [P] [US1] Create Vite build config for `apps/web` — `apps/web/vite.config.ts`
...
- [x] T014 [P] [US1] Create HTML entry point for `apps/web` — `apps/web/index.html`
...
- [x] T015 [P] [US1] Create SPA redirect config for static hosting — `apps/web/public/_redirects`
  - AC: Contains exactly `/* /index.html 200`; enables deep-link navigation on Netlify/Vercel without 404
- [x] T016 [P] [E2E] Create Playwright config — `e2e/playwright.config.ts`
...
- [x] T017 [P] [US1] Define all shared TypeScript interfaces and types — `packages/ui/src/types.ts`
...
- [x] T018 [P] [US1] Implement Ant Design space theme token overrides — `packages/ui/src/theme/spaceTheme.ts`
  ...
  - Depends on: T017
- [x] T019 [P] [US2] Define feature cards static content — `packages/ui/src/constants/featureCards.ts`
  ...
  - Depends on: T017
- [x] T020 [P] [US6] Define company info static content — `packages/ui/src/constants/companyInfo.ts`
  - AC: Exports `COMPANY_INFO: CompanyInfo` with non-empty `address`, `email`, `phone`, and `tagline` fields
  - Depends on: T017
- [x] T021 [P] [US7] Define nav links static content — `packages/ui/src/constants/navLinks.ts`
  - AC: Exports `NAV_LINKS: NavLink[]` containing at minimum `{ label: 'Home', to: '/' }` and `{ label: 'Contact', to: '/contact' }`
  - Depends on: T017
- [x] T022 [P] [US5] Implement mock contact submit utility — `packages/ui/src/utils/mockSubmit.ts`
  ...
  - Depends on: T017
- [x] T023 [P] [US1] Implement `SectionWrapper` component — `packages/ui/src/components/SectionWrapper/SectionWrapper.tsx`
  ...
  - Depends on: T017
- [x] T024 [P] [US1] Create `SectionWrapper` CSS module — `packages/ui/src/components/SectionWrapper/SectionWrapper.module.css`
  - AC: `.wrapper` sets `padding: 4rem 1.5rem`; `.inner` sets `max-width: 1200px; margin: 0 auto`; no horizontal overflow at 320 px viewport
  - Depends on: T023
- [x] T025 [P] [US1] Write `SectionWrapper` unit tests — `packages/ui/src/components/SectionWrapper/SectionWrapper.test.tsx`
...
- [x] T026 [P] [US1] Create `SectionWrapper` barrel export — `packages/ui/src/components/SectionWrapper/index.ts`
  - AC: Re-exports `SectionWrapper` as named and default export; TypeScript resolves without error
  - Depends on: T023
- [x] T027 [P] [US1] Create `packages/ui` barrel index — `packages/ui/src/index.ts`
...
- [x] T028 [P] [US7] Write `Navbar` unit and integration tests — `packages/ui/src/components/Navbar/Navbar.test.tsx`
...
- [x] T029 [P] [US7] Implement `Navbar` component — `packages/ui/src/components/Navbar/Navbar.tsx`
...
- [x] T030 [P] [US7] Create `Navbar` CSS module — `packages/ui/src/components/Navbar/Navbar.module.css`
  ...
  - Depends on: T029
- [x] T031 [P] [US7] Create `Navbar` barrel export — `packages/ui/src/components/Navbar/index.ts`
...
- [x] T032 [P] [US8] Write `Footer` unit tests — `packages/ui/src/components/Footer/Footer.test.tsx`
  ...
  - Depends on: T017
- [x] T033 [P] [US8] Implement `Footer` component — `packages/ui/src/components/Footer/Footer.tsx`
...
- [x] T034 [P] [US8] Create `Footer` CSS module — `packages/ui/src/components/Footer/Footer.module.css`
  ...
  - Depends on: T033
- [x] T035 [P] [US8] Create `Footer` barrel export — `packages/ui/src/components/Footer/index.ts`
...
- [x] T036 [P] [US1] Write `Hero` unit tests — `packages/ui/src/components/Hero/Hero.test.tsx`
  ...
  - Depends on: T017
- [x] T037 [P] [US1] Implement `Hero` component — `packages/ui/src/components/Hero/Hero.tsx`
...
- [x] T038 [P] [US1] Create `Hero` CSS module — `packages/ui/src/components/Hero/Hero.module.css`
  ...
  - Depends on: T037
- [x] T039 [P] [US1] Create `Hero` barrel export — `packages/ui/src/components/Hero/index.ts`
...
- [x] T040 [P] [US2] Write `FeatureCard` unit tests — `packages/ui/src/components/FeatureCard/FeatureCard.test.tsx`
  ...
  - Depends on: T017
- [x] T041 [P] [US2] Implement `FeatureCard` component — `packages/ui/src/components/FeatureCard/FeatureCard.tsx`
...
- [x] T042 [P] [US2] Create `FeatureCard` CSS module — `packages/ui/src/components/FeatureCard/FeatureCard.module.css`
  ...
  - Depends on: T041
- [x] T043 [P] [US2] Create `FeatureCard` barrel export — `packages/ui/src/components/FeatureCard/index.ts`
  - AC: Re-exports `FeatureCard` as named and default export; `FeatureCardProps` type re-exported
  - Depends on: T041
- [x] T044 [P] [US2] Write `FeaturesGrid` unit tests — `packages/ui/src/components/FeaturesGrid/FeaturesGrid.test.tsx`
...
- [x] T045 [P] [US2] Implement `FeaturesGrid` component — `packages/ui/src/components/FeaturesGrid/FeaturesGrid.tsx`
...
- [x] T046 [P] [US2] Create `FeaturesGrid` barrel export — `packages/ui/src/components/FeaturesGrid/index.ts`
...
- [x] T047 [P] [US3] Write `MissionStrip` unit tests — `packages/ui/src/components/MissionStrip/MissionStrip.test.tsx`
  ...
  - Depends on: T017
- [x] T048 [P] [US3] Implement `MissionStrip` component — `packages/ui/src/components/MissionStrip/MissionStrip.tsx`
...
- [x] T049 [P] [US3] Create `MissionStrip` CSS module — `packages/ui/src/components/MissionStrip/MissionStrip.module.css`
  ...
  - Depends on: T048
- [x] T050 [P] [US3] Create `MissionStrip` barrel export — `packages/ui/src/components/MissionStrip/index.ts`
...
- [x] T051 [P] [US4] Write `CtaBanner` unit tests — `packages/ui/src/components/CtaBanner/CtaBanner.test.tsx`
  ...
  - Depends on: T017
- [x] T052 [P] [US4] Implement `CtaBanner` component — `packages/ui/src/components/CtaBanner/CtaBanner.tsx`
...
- [x] T053 [P] [US4] Create `CtaBanner` CSS module — `packages/ui/src/components/CtaBanner/CtaBanner.module.css`
  ...
  - Depends on: T052
- [x] T054 [P] [US4] Create `CtaBanner` barrel export — `packages/ui/src/components/CtaBanner/index.ts`
...
- [x] T055 [P] [US5] Write `ContactForm` unit and integration tests — `packages/ui/src/components/ContactForm/ContactForm.test.tsx`
...
- [x] T056 [P] [US5] Implement `ContactForm` component — `packages/ui/src/components/ContactForm/ContactForm.tsx`
...
- [x] T057 [P] [US5] Create `ContactForm` CSS module — `packages/ui/src/components/ContactForm/ContactForm.module.css`
  ...
  - Depends on: T056
- [x] T058 [P] [US5] Create `ContactForm` barrel export — `packages/ui/src/components/ContactForm/index.ts`
...
- [x] T059 [P] [US6] Write `CompanyInfoBlock` unit tests — `packages/ui/src/components/CompanyInfoBlock/CompanyInfoBlock.test.tsx`
...
- [x] T060 [P] [US6] Implement `CompanyInfoBlock` component — `packages/ui/src/components/CompanyInfoBlock/CompanyInfoBlock.tsx`
...
- [x] T061 [P] [US6] Create `CompanyInfoBlock` CSS module — `packages/ui/src/components/CompanyInfoBlock/CompanyInfoBlock.module.css`
  ...
  - Depends on: T060
- [x] T062 [P] [US6] Create `CompanyInfoBlock` barrel export — `packages/ui/src/components/CompanyInfoBlock/index.ts`
...
- [x] T063 [P] [US1] Implement React app entry point — `apps/web/src/main.tsx`
...
- [x] T064 [P] [US1] Implement app router and layout shell — `apps/web/src/App.tsx`
...
- [x] T065 [P] [US1] Implement `LandingPage` page component — `apps/web/src/pages/LandingPage.tsx`
...
- [x] T066 [P] [US5] Implement `ContactPage` page component — `apps/web/src/pages/ContactPage.tsx`
...
- [x] T067 [P] [E2E] [US1,US2,US3,US4] Landing page render and no-overflow E2E test — `e2e/landing.spec.ts`
  ...
  - Depends on: T065
- [x] T068 [P] [E2E] [US7,US8] Navbar routing and footer E2E test — `e2e/navigation.spec.ts`
...
- [x] T069 [P] [E2E] [US5] Contact form validation and happy-path E2E test — `e2e/contact-form.spec.ts`
  ...
  - Depends on: T066
- [x] T070 [P] [E2E] [US7] Mobile navbar drawer E2E test — `e2e/mobile-navbar.spec.ts`
...
- [x] T071 [US7] Accessibility audit and remediation for `Navbar` — `packages/ui/src/components/Navbar/Navbar.tsx`
  ...
  - Depends on: T070
- [x] T072 [US5] Accessibility audit and remediation for `ContactForm` — `packages/ui/src/components/ContactForm/ContactForm.tsx`
  ...
  - Depends on: T069
- [x] T073 [US1] Bundle size verification and Vite chunk config — `apps/web/vite.config.ts`
